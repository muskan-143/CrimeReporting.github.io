            ...
            class h {
                ...
                sort(t, e, s) {
                    ...
                    if ("date" === c.getAttribute("data-type")) {
                        let t = !1;
                        c.hasAttribute("data-format") && (t = c.getAttribute("data-format")), p.push(Promise.resolve().then((function() { return require("./date-170bba30.js.js") })).then((({ parseDate: e }) => s => e(s, t))))
                    }
