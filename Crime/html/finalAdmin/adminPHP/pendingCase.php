...
<body>
    ...
    <div id="main" style="color:white">
        ...
        <div class="head my-2">
            <div class="col-div-6">
                <span style="font-size:30px;cursor:pointer; color: white;" class="nav">&#9776; Pending Case</span>
                <span style="font-size:30px;cursor:pointer; color: white;" class="nav2">&#9776; Pending Case</span>
        ...
        <div class="table-scroll mx-4">
            <center>
                <h4 id="ps_header_text my-4">PENDING CASES LIST</h4>
            </center>
            ...
            <?php
            include "pendingCaseDisplayQuery.php";
            ?>
